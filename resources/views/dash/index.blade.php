...
<div class="flex justify-center">
  @if (session('success'))
    <h5 class="sm:col-span-2 text-center py-2 px-24 bg-green-100 rounded-xl text-slate-500 mt-[1rem]">{{ session('success') }}Proyecto creado con exito</h5>
  @endif
    ...
    <!-- etiqueta details para desplagar los detalles del proyecto -->
      ...
      <summary>
        ...
        <form action="" method="post" class="flex justify-end">
          @csrf
          <input type="number" value="{{ $project->id }}" disabled hidden>
